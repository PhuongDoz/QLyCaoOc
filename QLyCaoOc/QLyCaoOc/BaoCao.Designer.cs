...
namespace QLyCaoOc {
    ...
    public partial class BaoCao : global::System.Data.DataSet {
        ...
        public partial class HOPDONGDataTable : global::System.Data.TypedTableBase<HOPDONGRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public HOPDONGRow AddHOPDONGRow(System.DateTime NgayLap, int TienCoc, int MaCongTy) {
        ...
        public partial class HOPDONGRow : global::System.Data.DataRow {
            ...
            public int MaCongTy {
                get {
                    return ((int)(this[this.tableHOPDONG.MaCongTyColumn]));
                }
                set {
                    this[this.tableHOPDONG.MaCongTyColumn] = value;
                }
            }
        }
...
namespace QLyCaoOc.BaoCaoTableAdapters {
    ...
    public partial class HOPDONGTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[HOPDONG] WHERE (([MaHD] = @Original_MaHD))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[HOPDONG] ([NgayLap], [TienCoc], [MaCongTy]) VALUES (@NgayLap, " +
                "@TienCoc, @MaCongTy)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[HOPDONG] SET [NgayLap] = @NgayLap, [TienCoc] = @TienCoc, [MaCongTy]" +
                " = @MaCongTy WHERE (([MaHD] = @Original_MaHD))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["dbQLyCaoOc"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaHD, NgayLap, TienCoc, MaCongTy FROM dbo.HOPDONG";
        ...
        public virtual int Fill(BaoCao.HOPDONGDataTable dataTable) {
        ...
        public virtual BaoCao.HOPDONGDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BaoCao.HOPDONGDataTable dataTable = new BaoCao.HOPDONGDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BaoCao.HOPDONGDataTable dataTable) {
        ...
        public virtual int Insert(System.DateTime NgayLap, int TienCoc, int MaCongTy) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((System.DateTime)(NgayLap));
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(TienCoc));
            this.Adapter.InsertCommand.Parameters[2].Value = ((int)(MaCongTy));
        ...
        public virtual int Update(System.DateTime NgayLap, int TienCoc, int MaCongTy, int Original_MaHD) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((System.DateTime)(NgayLap));
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(TienCoc));
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(MaCongTy));
